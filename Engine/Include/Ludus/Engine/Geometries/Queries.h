...
#include <Ludus/Engine/Physics/Broadphase/BroadphaseDebugInfo2D.h>
#include <Ludus/Engine/Physics/Narrowphase/ContactPoint2D.h>

namespace Ludus::Engine::Geometries::Queries
{
	/// <summary>
	...
	inline static bool OverlapAABB(const Ludus::Engine::Math::AABB& a, const Ludus::Engine::Math::AABB& b)
	{
	...
	inline static bool OverlapAABB_Debug(
		const Ludus::Engine::Math::AABB& a,
		const Ludus::Engine::Math::AABB& b,
		Ludus::Engine::Physics::Broadphase::BroadphaseDebugInfo2D& info
	)
	{
	...
	inline static bool IntersectionAABB_AABB(
		const Ludus::Engine::Math::AABB& a,
		const Ludus::Engine::Math::AABB& b,
		Ludus::Engine::Physics::Narrowphase::ContactPoint2D& contactPoint
	)
	{
		static const Ludus::Engine::Math::Vector2D faces[4] =
		{
			Ludus::Engine::Math::Vector2D(-1, 0), Ludus::Engine::Math::Vector2D(1, 0),
			Ludus::Engine::Math::Vector2D(0, -1), Ludus::Engine::Math::Vector2D(0, 1),
		};
		...
		Ludus::Engine::Math::Vector2D bestAxis;
		...
		contactPoint = Ludus::Engine::Physics::Narrowphase::ContactPoint2D(
			Ludus::Engine::Math::Vector2D::Zero(),
			Ludus::Engine::Math::Vector2D::Zero(),
