...
{
	PlayingSystem::PlayingSystem(Pong::Core::GameInfo& gameInfo, Pong::Core::PongInfo& pongInfo)
		: m_GameInfo(gameInfo),
		m_PongInfo(pongInfo),
		m_LayerIndexBall(-1),
	...
	void PlayingSystem::OnAttachImpl()
	{
		...
		m_RenderData.DefaultPlayer1Position = { Pong::Core::Configuration::Defaults::PaddleXOffset, m_RenderData.GetHalfHeight() };
		m_RenderData.DefaultPlayer2Position = { (float)m_RenderData.Width - Pong::Core::Configuration::Defaults::PaddleXOffset, m_RenderData.GetHalfHeight() };
	...
	void PlayingSystem::OnTransitionEnterImpl()
	{
		...
		ecs.AttachTransform(m_Entities.LeftScoreTextHandle, { m_RenderData.GetHalfWidth() - Pong::Core::Configuration::Defaults::ScoreTextOffset, m_RenderData.Height - Pong::Core::Configuration::Defaults::ScoreTextOffset });
		...
		ecs.AttachTransform(m_Entities.RightScoreTextHandle, { m_RenderData.GetHalfWidth() + Pong::Core::Configuration::Defaults::ScoreTextOffset, m_RenderData.Height - Pong::Core::Configuration::Defaults::ScoreTextOffset });
	...
	void PlayingSystem::UpdateImpl(float deltaTime)
	{
		...
		{
			state = Pong::Core::GameState::PauseMenu;
		}
		...
		if (state != Pong::Core::GameState::Playing)
		{
		...
		const auto halfPaddleHeight = Pong::Core::Configuration::Defaults::PaddleHeight * 0.5f;
		const auto minY = Pong::Core::Configuration::Defaults::WallHeightThickness + halfPaddleHeight;
		const auto maxY = m_RenderData.Height - Pong::Core::Configuration::Defaults::WallHeightThickness - halfPaddleHeight;
