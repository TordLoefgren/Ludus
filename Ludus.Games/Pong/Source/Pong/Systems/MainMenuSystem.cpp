...
{
	MainMenuSystem::MainMenuSystem(Pong::Core::GameInfo& gameInfo, Pong::Core::PongInfo& pongInfo)
	...
	void MainMenuSystem::OnTransitionExitImpl()
	{
		auto& ecs = m_SystemContext->EntityComponentSystem;
	...
	void MainMenuSystem::UpdateImpl(float deltaTime)
	{
