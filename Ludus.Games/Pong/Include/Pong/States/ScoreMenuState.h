...
{
	class ScoreMenuState : IPongState
	{
	private:
		int m_MenuIndex = 1;
	...
	public:
		ScoreMenuState(Pong::Core::GameInfo& gameInfo, Pong::Core::PongInfo& pongInfo) : IPongState(gameInfo, pongInfo) { }
		~ScoreMenuState() = default;
